...
func (g *certificateManagerSecretGetter) GetSecret(ctx context.Context, iamToken, resourceID string, lookupBy common.LookUpBy, folderID, versionID, property string) ([]byte, error) {
...
func (g *certificateManagerSecretGetter) GetSecretMap(ctx context.Context, iamToken, resourceID string, lookupBy common.LookUpBy, folderID, versionID string) (map[string][]byte, error) {
	response, err := g.certificateManagerClient.GetCertificateContent(ctx, iamToken, resourceID, versionID)
	if err != nil {
