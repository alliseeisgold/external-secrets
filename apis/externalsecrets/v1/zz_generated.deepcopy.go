...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceSA) DeepCopyInto(out *InstanceSA) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceSA.
func (in *InstanceSA) DeepCopy() *InstanceSA {
	if in == nil {
		return nil
	}
	out := new(InstanceSA)
...
func (in *YandexAuth) DeepCopyInto(out *YandexAuth) {
	*out = *in
	...
	if in.InstanceSA != nil {
		in, out := &in.InstanceSA, &out.InstanceSA
		*out = new(InstanceSA)
		**out = **in
	}
}
